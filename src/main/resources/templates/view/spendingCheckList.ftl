                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="well with-header with-footer">
                            ...
                            <div style="float:right;margin-right:2px;">
                                ...
                                <div class="form-group">
                                    <select id="selectType">
                                        <option value="1" <#if checkStatus==1>selected</#if> >已拨款 <span
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr id="${p.getSpendingInfo().getId()}">
                                    <td>${p.getSpendingInfo().getMonth()}</td>
...
<script>
    ...
    $(function () {
        ...
        $("#fa-search").click(function () {
            var month = $("#month").val();
            if (month != "") {
                location = "/oa/spending/checkList.html?month=" + month
            }
        })
        $("input[type=checkbox]").click(function () {
            var resultStatus = $(this).val();
            var month = $("#month").val();
            location = "/oa/spending/checkList?month=" + month + "&checkStatus=1&resultStatus=" + resultStatus

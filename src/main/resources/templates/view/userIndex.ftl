                        ...
                        <div class="profile-container">
                            <div class="profile-header row">
                                <div class="col-lg-2 col-md-4 col-sm-12 text-center">
                                    <img <#if userInfo.getAvatar()! == ""> src="/layui/images/model.jpg"<#else > src="${userInfo.getAvatar()!}"</#if> alt="赶紧上传自己的头像吧" class="header-avatar"/>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="profile-contacts">
                                                            ...
                                                            <div class="contact-info">
                                                                ...
                                                                <#if userInfo.getUserType()=="anchor">
                                                                    <div class="profile-badge azure">
                                                                        <i class="fa fa-file-text-o azure"></i><span>工资信息</span>
                                                                    </div>
                                                                <div class="contact-info">
                                                                    <#list anchorInfoList as anchor>
                                                                        <p>
                                                                            <span>平台：${anchor.getLivePlatform()!}</span>
                                                                        </span>
                                                                            <br><br>
                                                                            <span>提现记录：</span>
                                                                            <a id="tiXian" href="/oa/withdraw/list/user.html?platform=${anchor.getPlatformId()}"
                                                                               class="btn btn-sky btn-sm  btn-follow">
                                                    ...
                                                    <div class="col-md-6">
                                                        <img id="contact-map" class="animated flipInY" alt="赶紧上传自己的头像吧"
                                                             <#if userInfo.getAvatar()! ==""> src="/layui/images/model.jpg"<#else > src="${userInfo.getAvatar()!}"</#if>/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

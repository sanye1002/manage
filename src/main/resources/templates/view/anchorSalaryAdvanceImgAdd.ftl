                        ...
                        <div class="widget-body">
                            ...
                            <div class="form-group ">
                                <div class="text-right" style="margin-right:16px;">
                                    <a class="btn btn-success" id="delete" ><i
                                            class="btn-label glyphicon glyphicon-ok"></i> 取消</a>
                                    <a class="btn btn-success" id="submit"><i
...
<script>
    var flog = true;
    var id =  ${anchorSalaryAdvance.getId()};
    $(function () {
            ...
            if (flog) {
                $.post(
                        ...
                        function (res) {
                            ...
                            if (res.code == 0) {
                                setTimeout(function () {
                                    location = "/oa/anchorSalaryAdvance/index.html"
                                }, 1000)
                            }
                            //如果上传失败
                            if (res.code > 0) {
        ...
        layui.use('upload', function () {
            ...
            upload.render({
                elem: '#image-select'
                , url: '/upload/imgs/anchorSalaryAdvance/${anchorSalaryAdvance.getId()}'
                , auto: false
                , multiple: true
                , acceptMime: 'image'

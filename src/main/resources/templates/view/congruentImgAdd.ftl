                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <div class="widget" id="imgBox">
                        <div class="widget-header ">
                            <span class="widget-caption">劳动合同图片</span>
                        </div>
                        <div class="widget-body">
                            <div class="form-group ">
                                <form class="form-horizontal form-bordered" role="form" id="gravaForm"
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right">必须上传</label>
                            ...
                            <div class="form-group ">
                                <div class="text-right" style="margin-right:16px;">
                                    <a class="btn btn-yellow" id="delete" href="javascript:void(0);"><i
...
<script>
    ...
    $(function () {
        ...
        layui.use('upload', function () {
            ...
            upload.render({
                elem: '#image-select'
                , url: '/upload/imgs/congruent/${userInfo.getId()}'
                , auto: false
                , multiple: true
                , acceptMime: 'image'

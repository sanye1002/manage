                        ...
                        <div class="well with-header with-footer">
                            ...
                            <div class="table-scrollable">
                                ...
                                <tr id="${items.id}"
                                    ...
                                    <td>${items.getApplicationCase().getCheckPersonnelName()!}</td>
                                    ...
                                    <#else >
                                        ...
                                        <td>${items.getBackCase().getCheckPersonnelName()!}</td>
                                    </#if>

                                    <td>

                                        <a class="btn btn-blueberry btn-xs"><i class="fa fa-check-square"></i> 自读</a>
                                    </td>

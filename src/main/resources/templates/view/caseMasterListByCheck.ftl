                        ...
                        <div class="well with-header with-footer">
                            ...
                            <div class="table-scrollable">
                                ...
                                <tr id="${items.id}"
                                    ...
                                    <#if items.getApplicationCase().getResultStatus()==0>class="warning"</#if>
                                    ...
                                    <td><#if items.getApplicationCase().getGoOut()==0>
                                        不外出</#if><#if items.getApplicationCase().getGoOut()==1>外出</#if></td>
                                    <td>
                                    ...
                                    <td>
                                        <#if  items.getApplicationCase().getCheckStatus()==0>
                                            <a onclick="grantsApplication('${items.getApplicationCase().getId()}',1)"
                                               class="btn btn-info btn-xs"><i class="fa fa-edit">通过申请</i></a>
                                            <a onclick="grantsApplication('${items.getApplicationCase().getId()}',0)"
                                               class="btn btn-blueberry btn-xs"><i class="fa fa-check-square"></i> 不通过申请</a>
                                        <#else >
                                            <a class="btn btn-blueberry btn-xs"><i class="fa fa-check-square"></i>
                                                已审核</a>
                                        </#if>
                                    </td>
                                    <td>
                                        <#if  items.getBackCase().getId()==0>
                                            <a class="btn btn-warning btn-xs"><i class="fa fa-times"></i>无回执记录</a>
                                        <#elseif items.getBackCase().getCheckStatus()==1>
                                           <a class="btn btn-warning btn-xs"><i class="fa fa-times"></i> 回执已审核</a>
                                        <#elseif items.getBackCase().getCheckStatus()==0>
                                           <a onclick="grantsBack('${items.getBackCase().getId()}',1)"
                                              class="btn btn-info btn-xs"><i class="fa fa-edit">通过回执</i></a>
                                             <a onclick="grantsBack('${items.getBackCase().getId()}',0)"
                                                class="btn btn-blueberry btn-xs"><i class="fa fa-check-square"></i> 不通过回执</a>
                                        </#if>
                                    </td>
...
<script>
    ...
    function grantsApplication(id, resultStatus) {
    ...
    function grantsBack(id, resultStatus) {
        layer.prompt({title: '输入备注，并确认', formType: 2}, function (remark, index) {
            if (remark == "") {
                layer.msg('备注必填！！！', {
                    time: 1200
